...
const LandingBanner: FC = () => {
  return (
    <div className="md:py-40 sm:py-20 py-10 bg-cover text-gray-50 bg-[url(https://sxcontent9668.azureedge.us/cms-assets/assets/Star4_37_outsidebeach_IMG_4152_1_desktop_1_0ae909e40a.jpg)]">
